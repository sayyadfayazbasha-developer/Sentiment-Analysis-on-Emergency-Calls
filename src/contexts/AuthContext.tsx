...
interface AuthContextType {
  ...
  verifyOTPAndResetPassword: (otpToken: string, otp: string, newPassword: string) => Promise<{ error: Error | null }>;
}
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const verifyOTPAndResetPassword = async (otpToken: string, otp: string, newPassword: string) => {
    try {
      const { data, error } = await supabase.functions.invoke('verify-otp', {
        body: { otpToken, otp, newPassword }
      });
